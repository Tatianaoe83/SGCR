    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-2">
                    ...
                    <span class="mx-2">></span>
                    <span class="text-gray-400 dark:text-gray-500">Editar Unidad de Negocio</span>
                </div>
                
                <!-- Main Title -->
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Editar Unidad de Negocio</h1>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700">
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">Editar Unidad de Negocio: {{ $unidadNegocio->nombre }}</h2>
            </header>
            <div class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                type="text" 
                                class="form-input w-full" 
                                value="{{ old('nombre', $unidadNegocio->nombre) }}"

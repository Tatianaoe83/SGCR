        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-2">
                    ...
                    <span class="mx-2">></span>
                    <span class="text-gray-400 dark:text-gray-500">Unidades de Negocio</span>
                </div>
                            ...
                            @forelse($unidadesNegocio as $unidadNegocio)
                                <tr>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left">{{ $unidadNegocio->id }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center">
                                            <div class="inline-flex" role="group">
                                                <a href="{{ route('unidades-negocios.show', $unidadNegocio->id) }}" class="btn bg-slate-150 hover:bg-slate-200 text-slate-600 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-300">
                                                ...
                                                <form action="{{ route('unidades-negocios.destroy', $unidadNegocio->id) }}" method="POST" class="inline" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta unidad de negocio?')">
                                                    @csrf
                                                    @method('DELETE')

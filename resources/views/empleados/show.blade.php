    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8 mt-11">
            ...
            <div class="flex flex-wrap items-center space-x-2">
                <a href="{{ route('divisions.edit', $division->id_division) }}" class="btn border-slate-200 hover:border-slate-300 text-slate-600">
            ...
            <div class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 dark:text-gray-100 font-medium">{{ $division->nombre }}</p>
                    </div>

                    <!-- Fecha de Creación -->
                    <div>
                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Fecha de Creación</label>
                        <p class="text-gray-800 dark:text-gray-100">{{ $division->created_at->format('d/m/Y H:i:s') }}</p>
                    </div>

                    <!-- Fecha de Actualización -->
                    <div>
                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Última Actualización</label>
                        <p class="text-gray-800 dark:text-gray-100">{{ $division->updated_at->format('d/m/Y H:i:s') }}</p>
                    </div>

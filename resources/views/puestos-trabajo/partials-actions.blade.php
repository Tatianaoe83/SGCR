<div class="flex items-center justify-center gap-1">
    ...
    {{-- VER --}}
    @can('puestos-trabajo.view')
        <a href="{{ route('puestos-trabajo.show', $puesto->id_puesto_trabajo) }}"
    ...
    {{-- EDITAR --}}
    @can('puestos-trabajo.edit')
        <a href="{{ route('puestos-trabajo.edit', $puesto->id_puesto_trabajo) }}"
            class="inline-flex items-center justify-center w-8 h-8 rounded-md

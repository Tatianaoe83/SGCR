<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <ul class="text-blue-700 dark:text-blue-300 space-y-1 text-sm">
                        ...
                        <li>• Asegúrate de que las divisiones, unidades de negocio y áreas existan en el sistema</li>
        ...
        <div class="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
            <div class="p-6">
                <form action="{{ route('puestos-trabajo.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
                            ...
                            <a href="{{ route('puestos-trabajo.template') }}" 

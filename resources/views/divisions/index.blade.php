<x-app-layout>
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-2">
                    ...
                    <span class="mx-2">></span>
                    <span class="text-gray-400 dark:text-gray-500">Divisiones</span>
                </div>
                        ...
                        <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($divisions as $division)
                                <tr>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left">{{ $division->id_division }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left font-medium text-gray-800 dark:text-gray-100">{{ $division->nombre }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left">{{ $division->created_at->format('d/m/Y H:i') }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center">
                                            <div class="inline-flex" role="group">
                                                <a href="{{ route('divisions.show', $division->id_division) }}" class="btn bg-slate-150 hover:bg-slate-200 text-slate-600 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-300">
                                                ...
                                                <form action="{{ route('divisions.destroy', $division->id_division) }}" method="POST" class="inline" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta división?')">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center text-gray-500 dark:text-gray-400">No hay divisiones registradas</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left">-</div>
                                    </td>
    ...
    <x-datatable tableId="divisionsTable" :orderColumn="0" orderDirection="desc" :pageLength="10" />
</x-app-layout> 
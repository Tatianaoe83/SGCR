                            ...
                            @forelse($divisions as $division)
                                <tr>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left">{{ $division->id }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center">
                                            <div class="inline-flex" role="group">
                                                <a href="{{ route('divisions.show', $division->id) }}" class="btn bg-slate-150 hover:bg-slate-200 text-slate-600 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-300">
                                                ...
                                                <form action="{{ route('divisions.destroy', $division->id) }}" method="POST" class="inline" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta división?')">
                                                    @csrf
                                                    @method('DELETE')

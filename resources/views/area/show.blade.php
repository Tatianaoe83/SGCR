        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mb-2">
                    ...
                    <span class="mx-2">></span>
                    <span class="text-gray-400 dark:text-gray-500">{{ $area->nombre }}</span>
                </div>
            ...
            <div class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 dark:text-gray-100">{{ $area->id_area }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 dark:text-gray-100">{{ $area->created_at->format('d/m/Y H:i:s') }}</p>
                    </div>

                    <!-- Fecha de Actualización -->
                    <div>
                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Última Actualización</label>
                        <p class="text-gray-800 dark:text-gray-100">{{ $area->updated_at->format('d/m/Y H:i:s') }}</p>
                    </div>

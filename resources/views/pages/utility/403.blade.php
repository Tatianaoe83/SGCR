    ...
    <main class="flex-grow flex flex-col items-center justify-center p-6 relative">
      ...
      <div class="layout-content-container flex flex-col items-center max-w-2xl w-full z-10 text-center animate-fade-in-up">
        <div class="mb-6 size-20 rounded-full bg-primary/10 flex items-center justify-center text-primary shadow-sm ring-1 ring-primary/20">
          <span class="material-symbols-outlined text-[40px]">link_off</span>
        </div>

        <h1 class="text-primary tracking-tighter text-[120px] md:text-[160px] font-extrabold leading-none select-none drop-shadow-sm">
          403
        </h1>

        <h2 class="text-text-main dark:text-[#fcf8f8] text-2xl md:text-3xl font-bold leading-tight tracking-tight mt-2 px-4">
          Oops! Este link ha caducado.
        </h2>

        <p class="text-text-muted dark:text-[#bcaaaa] text-base md:text-lg font-normal leading-relaxed max-w-lg mt-4 px-4">
          Este enlace ya no está disponible porque su tiempo de validez ha expirado.
        </p>

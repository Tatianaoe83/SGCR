            ...
            <form action="{{ route('tipo-elementos.update', $tipoElemento->id_tipo_elemento) }}" method="POST" class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
                        Selecciona los campos que serán requeridos al crear elementos de este tipo.
                    </p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-150 border border-gray-200 dark:border-gray-600">
                            <input
                                ...
                                {{ in_array($campoNombre, $camposSeleccionados) ? 'checked' : '' }}>
                ...
                <script>
                    function marcarTodos() {
                        document.querySelectorAll('input[name="campos_requeridos[]"]').forEach(el => el.checked = true);
                    }

                    function desmarcarTodos() {
                        document.querySelectorAll('input[name="campos_requeridos[]"]').forEach(el => el.checked = false);
                    }
                </script>
